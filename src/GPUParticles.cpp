...
bool GPUParticles::StartUp()
{
	...
	m_emitter.Init(1000, vec3(0, 0, 0), 50.0f, 2.5f, 5, 2.5f, 5, 0.5f, 2.5f, vec4(1, 0, 0, 1), vec4(1, 1, 0, 1));
...
void GPUParticles::Draw()
{
	...
	m_emitter.Draw(m_time, m_camera->m_worldTransform, m_camera->m_projectionView);
